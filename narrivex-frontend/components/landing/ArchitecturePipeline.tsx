...
const stages: PipelineStage[] = [
  {
    ...
    title: 'High-Frequency Multi-Venue Sockets',
    icon: Database,
    description:
    ...
    samplePayload: `// INGESTION RING BUFFER [BINANCE_FUTURES_L3]
{
  ...
  },
  {
    ...
    title: 'Non-Linear Anomaly Detection',
    icon: Binary,
    description:
    ...
    samplePayload: `// ANOMALY VECTOR [Z-SCORE: +3.84σ]
{
  ...
  },
  {
    id: 'stage-3',
    step: '03',
    name: 'Contextual LLM Reasoning',
    title: 'Fine-Tuned Financial Narrative Model',
    icon: Sparkles,
    description:
    ...
    outputFormat: 'Plain-English Market Narrative',
    latencySpec: '38ms inference latency',
    features: ['Zero Hallucination Grounding', 'Multi-Asset Correlation', 'Actionable Invalidation'],
    samplePayload: `// DETERMINISTIC SYNTHESIS OUTPUT
{
  ...
  },
  {
    id: 'stage-4',
    step: '04',
    name: 'Sub-50ms Dispatch',
    title: 'Low-Latency Stream & Webhook Broadcast',
    icon: Send,
    description:
    ...
    latencySpec: '< 15ms broadcast transit',
    ...
    samplePayload: `// DISPATCH BROADCAST [/v2/stream/alpha]
{
  ...
  "timestamp": "2026-08-22T17:42:19.402Z",
    ...
    <section className="mb-24 rounded-3xl border border-slate-200/80 bg-white/80 p-6 shadow-sm backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/60 sm:p-10">
      ...
      <div className="mb-10 text-center">
        ...
        <h2 className="mt-3 font-display text-3xl font-bold md:text-5xl text-slate-900 dark:text-white">
          From Raw Market Chaos to Instant Actionable Conviction
        </h2>
        <p className="mx-auto mt-3 max-w-2xl text-base text-slate-600 dark:text-slate-400">
          Deterministic 4-layer quantitative-to-LLM pipeline operating under 50 milliseconds end-to-end.
        </p>
      </div>
            ...
            <div
              ...
              className={`cursor-pointer rounded-2xl border p-4 transition-all duration-200 ${
                isSelected
                  ...
                  : 'border-slate-200/80 bg-white/70 hover:border-slate-300 dark:border-slate-800 dark:bg-slate-900/60 dark:hover:border-slate-700'
              }`}
            >
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-6 dark:border-slate-800 dark:bg-slate-950/80">
        <div className="grid gap-6 lg:grid-cols-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs font-mono">
              <div className="rounded-xl border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
                ...
                <p className="mt-0.5 font-semibold text-slate-800 dark:text-slate-200">{activeStage.inputFormat}</p>
              </div>
              <div className="rounded-xl border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
                <span className="text-[10px] text-slate-400 uppercase">Output Result</span>
                <p className="mt-0.5 font-semibold text-sea">{activeStage.outputFormat}</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-6">
            <div className="rounded-xl border border-slate-800 bg-slate-950 p-4 font-mono text-xs shadow-lg">
